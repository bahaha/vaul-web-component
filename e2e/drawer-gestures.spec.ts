...
test("should close drawer when clicking on backdrop @dismissible", async ({ page }) => {
...
test("should close drawer when pressing ESC key @dismissible", async ({ page }) => {
...
test("should not close when clicking on drawer content area @dismissible", async ({ page }) => {
...
test("should NOT close drawer when clicking on backdrop @non-dismissible", async ({ page }) => {
...
test("should NOT close drawer when pressing ESC key @non-dismissible", async ({ page }) => {
...
test("should NOT close drawer on multiple ESC presses @non-dismissible", async ({ page }) => {
...
test("should close when quick swipe down on bottom drawer @drag-to-dismiss @quick-swipe @bottom", async ({ page }) => {
...
test("should close when quick swipe up on top drawer @drag-to-dismiss @quick-swipe @top", async ({ page }) => {
    const { getDialogDescriber, openDrawer, performDrag } = await createDrawer({
        page,
        animationDuration: 100,
...
test("should close when quick swipe left on left drawer @drag-to-dismiss @quick-swipe @left", async ({ page }) => {
    const { getDialogDescriber, openDrawer, performDrag } = await createDrawer({
        page,
        animationDuration: 100,
...
test("should close when quick swipe right on right drawer  @drag-to-dismiss @quick-swipe @right", async ({ page }) => {
    const { getDialogDescriber, openDrawer, performDrag } = await createDrawer({
        page,
        animationDuration: 100,
...
test("should close when dragged long distance on bottom drawer @drag-to-dismiss @long-distance @bottom", async ({
    page,
}) => {
    const { getDialogDescriber, openDrawer, performDrag } = await createDrawer({
        page,
...
test("should close when dragged long distance on top drawer @drag-to-dismiss @long-distance @top", async ({ page }) => {
    const { getDialogDescriber, openDrawer, performDrag } = await createDrawer({
        page,
        animationDuration: 100,
        template: getDragToDismissDrawer("top"),
...
test("should close when dragged long distance on left drawer @drag-to-dismiss @long-distance @left", async ({
    page,
}) => {
    const { getDialogDescriber, openDrawer, performDrag } = await createDrawer({
        page,
...
test("should close when dragged long distance on right drawer @drag-to-dismiss @long-distance @right", async ({
    page,
}) => {
    const { getDialogDescriber, openDrawer, performDrag } = await createDrawer({
        page,
...
test("should NOT dismiss bottom drawer with low velocity and short distance @drag-to-dismiss @bottom", async ({
    page,
}) => {
    const { getDialogDescriber, openDrawer, performDrag } = await createDrawer({
        page,
...
test("should NOT dismiss top drawer with low velocity and short distance @drag-to-dismiss @top", async ({ page }) => {
    const { getDialogDescriber, openDrawer, performDrag } = await createDrawer({
        page,
        animationDuration: 100,
        template: getDragToDismissDrawer("top"),
...
test("should NOT dismiss left drawer with low velocity and short distance @drag-to-dismiss @left", async ({ page }) => {
    const { getDialogDescriber, openDrawer, performDrag } = await createDrawer({
        page,
        animationDuration: 100,
        template: getDragToDismissDrawer("left"),
...
test("should NOT dismiss right drawer with low velocity and short distance @drag-to-dismiss @right", async ({
    page,
}) => {
    const { getDialogDescriber, openDrawer, performDrag } = await createDrawer({
        page,
...
test("should apply damping when overdragging bottom drawer upward @drag-to-dismiss @damping @bottom", async ({
    page,
}) => {
    const { getDialogDescriber, openDrawer, performDrag } = await createDrawer({
        page,
...
test("should apply damping when overdragging top drawer downward @drag-to-dismiss @damping @top", async ({ page }) => {
    const { getDialogDescriber, openDrawer, performDrag } = await createDrawer({
        page,
        animationDuration: 100,
        template: getDragToDismissDrawer("top"),
...
test("should apply damping when overdragging left drawer rightward @drag-to-dismiss @damping @left", async ({
    page,
}) => {
    const { getDialogDescriber, openDrawer, performDrag } = await createDrawer({
        page,
...
test("should apply damping when overdragging right drawer leftward @drag-to-dismiss @damping @right", async ({
    page,
}) => {
    const { getDialogDescriber, openDrawer, performDrag } = await createDrawer({
        page,
...
test("should respect custom velocity threshold @drag-to-dismiss @custom-thresholds @bottom", async ({ page }) => {
...
test("should respect custom close threshold @drag-to-dismiss @custom-thresholds @bottom", async ({ page }) => {
    const customTemplate = `
...
test("should not dismiss drawer with dismissable=false @non-dismissible @drag-to-dismiss @bottom", async ({ page }) => {
    const customTemplate = `
...
function getDragToDismissDrawer(direction: Direction) {
    ...
    <vaul-drawer direction="${direction}">
        <vaul-drawer-trigger>Open drawer</vaul-drawer-trigger>
        <vaul-drawer-content style="--vaul-drawer-duration: 100ms;">
            <div style="${dimension} background: #1989;">Hello Web Component Drawer!</div>
        </vaul-drawer-content>
    </vaul-drawer>
`;
}
